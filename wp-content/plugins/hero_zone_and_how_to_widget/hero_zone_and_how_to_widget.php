...
class Hero_Zone_And_How_To_Widget extends WP_Widget
{
    ...
    public function widget($args, $instance)
    {
        ...
        if ($args['id'] == "how-to-widget") {
            $this->draw_how_to_html($instance);
        } else if ($args['id'] == "hero-zone-widget") {
    ...
    public function draw_hero_zone_html($instance)
    {
        ...
        include( locate_template( 'home-parts/herozone-template.php', false, false ) ); 
    }

    public function draw_how_to_html($instance)
    {
        $title = $instance['title'];
        $description = $instance['description'];
        $text_link = $instance['text_link'];
        $url_link = $instance['url_link'];
        $image_id = $instance['image_id'];
        include( locate_template( 'home-parts/howto-template.php', false, false ) ); 
    }
    // Widget Backend 
